...
public class Paciente {
   ...
   */
    ...
    */
    ...
    private ArrayList <Enfermeda>enfermedades;
    /*
    ...
    */
    public Paciente(String nombre, int id, int edad, String correo, int telefono, String estado, ArrayList<Enfermeda> enfermedades, ArrayList<Medicina> medicinas) {
        this.nombre = nombre;
        this.id = id;
        this.edad = edad;
        this.correo = correo;
    ...
    */
    ...
    public ArrayList<Enfermeda> getEnfermedades() {
        return enfermedades;
    }

    public void setEnfermedades(ArrayList<Enfermeda> enfermedades) {
        this.enfermedades = enfermedades;
    }
